...
export const LOADING_GROUPS = '[ToDos Group] Loading Groups';
...
export const LOADING_TASKS = '[ToDos Tasks] Loading Tasks';
...
export const USER_SIGNIN_FAIL = '[ToDos User] SignIn Fail';
